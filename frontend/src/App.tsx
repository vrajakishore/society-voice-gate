  ...
  return (
    <div style={styles.root}>
      <div style={styles.sidebar}>
        ...
        <div style={styles.navItem}>📋 Complaints</div>
        <div style={{ flex: 1 }} />
...
const styles: Record<string, React.CSSProperties> = {
  ...
  navItem: { padding: '12px 20px', fontSize: 14, cursor: 'pointer', background: '#2563eb', color: '#fff', margin: '8px 10px', borderRadius: 6 },
